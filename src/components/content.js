...
const BlockContent = function(){
	...
	<div className = 'content'>
			...
			<ul>
				<li>
					<img className = 'img' id="img1" src={img1} alt =  "Load image fail " />	
				...
				<li>
					<img className = 'img' id="img2" src={require("../image/img2.jpg")} alt =  "Load image fail "/>	
				...
				<li>
					<img className = 'img' id="img3" src={require("../image/img3.jpg")} alt =  "Load image fail "/>
				...
				<li>
					<img className = 'img' id="img4" src={require("../image/img4.jpg")} alt =  "Load image fail "/>	
				...
				<li>
					<img className = 'img' id="img5" src={require("../image/img5.jpg")} alt =  "Load image fail "/>
